...
export const IMAGE_URL = `${changed}images_upload/`;
export const changed_img = `https://kerakli.space`;

export const sharebase = "https://sharelinc.store/";
// export const sharebase = "http://localhost:3000/";
