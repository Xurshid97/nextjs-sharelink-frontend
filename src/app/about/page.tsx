  ...
  return (
    <div style={styles.container}>
      ...
      <ul style={styles.list}>
        <li>Effortless Link Collection: Add as many links as you want to your collection. Whether it&apos;s for a personal project, professional resources, or simply a list of your favorite websites, ShareLink has you covered.</li>
        ...
        <li>No Registration Required: Start using ShareLink immediately—no need to register first. We value your time and strive to provide instant access to our features.</li>
      ...
      <p style={styles.paragraph}>
        ShareLink is designed with user convenience in mind. We understand the importance of having a reliable tool to manage and share your links without unnecessary steps or complications. Our platform is intuitive, user-friendly, and accessible to everyone.
      </p>

      <h2 style={styles.subHeader}>Feedback and Support</h2>
      <p style={styles.paragraph}>
        We are continuously working to improve ShareLink and would love to hear from you. Any valid feedback is appreciated as it helps us enhance our services and provide a better experience for our users.
      </p>

      <p style={styles.paragraph}>
        Thank you for choosing ShareLink. We hope you enjoy using our platform as much as we enjoyed creating it for you.
      </p>
